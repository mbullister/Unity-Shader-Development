Shader "Teague/Anisotropic with 2-sample Dithering" {
	Properties {
		...
		Pass {   
			...
			half3 frag(vertexOutput i) : COLOR
			{
				...
				*/
				...
				//return CubeSample1.xyz;
				
				float3 CubeNormal2 = normalize(lerp(i.normalWorld, normalDirectionReverse, ditherPattern2 + 0.125));
				...
				//return pow(CubeSample2.xyz, 1/2.2);
				
				float3 reflection = (CubeSample1.xyz + CubeSample2.xyz) / 2;
				reflection *= reflectionMask.y;
				return pow(reflection, 0.454545);
			}
